...
sbatch --export=ALL,SSL=simclr,SEED=1,LR=1e-5,BATCH=64,PROJ=2048,LAY=2 ./script/train_msls_ssl_long_simclr_neg1.sbatch
sbatch --export=ALL,SSL=mocov2,SEED=1,LR=1e-5,BATCH=64,PROJ=2048,LAY=2 ./script/train_msls_ssl_long_simclr_neg1.sbatch
