...
# sbatch --export=ALL,SSL=byol,LR=1e-5,BATCH=64,PROJ=2048,LAY=2,NEG=0,FC=1024,NEGQ=0 ./script/train_msls_ssl_long_byol_neg_random_pair_large.sbatch
# sbatch --export=ALL,SSL=simsiam,LR=1e-5,BATCH=64,PROJ=2048,LAY=2,NEG=0,FC=1024,NEGQ=0 ./script/train_msls_ssl_long_byol_neg_random_pair_large.sbatch
# sbatch --export=ALL,SSL=byol,LR=1e-5,BATCH=64,PROJ=2048,LAY=2,NEG=1000,FC=1024,NEGQ=1 ./script/train_msls_ssl_long_byol_neg_partial_pair_aug_large.sbatch
# sbatch --export=ALL,SSL=simsiam,LR=1e-5,BATCH=64,PROJ=2048,LAY=2,NEG=1000,FC=1024,NEGQ=1 ./script/train_msls_ssl_long_byol_neg_partial_pair_aug_large.sbatch
