...
# sbatch --export=ALL,SSL=vicreg,LR=1e-5,BATCH=64,PROJ=4096,LAY=2,NEG=1000,FC=1024,NEGQ=1 ./script/train_msls_ssl_long_vicreg_neg_partial_pair_aug_large.sbatch
# sbatch --export=ALL,SSL=bt,LR=1e-5,BATCH=64,PROJ=4096,LAY=2,NEG=1000,FC=1024,NEGQ=1 ./script/train_msls_ssl_long_vicreg_neg_partial_pair_aug_large.sbatch
